...
const handleSaveOrder = async () => {
  ...
  // Validate customer name: only letters and spaces allowed
  const nameRegex = /^[a-zA-Z\s]+$/;
  if (!nameRegex.test(buyerName.trim())) {
    alert("Customer name can only contain letters and spaces. No numbers or special symbols allowed.");
    return;
  }
